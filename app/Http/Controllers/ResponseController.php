...
//                'new_users_id' => 'ok',//щось придумати з кодом щоб додавати id користувача в поле "new_users_id" що вже заєстрований/авторизовуний.
                'name' => $input['name'],
                'email' => $input['email'],
                'text' => $input['text'],
        ...
        if (view()->exists('responses')){
            ...
            if ($res_2 > 5){//максимальний рейтинг - 5
                $res_2 = 5;
            }
            if ($res_2){
...
//pagination
            ...
            $everything_responses_count = DB::table('responses')
                ->count('id');
                ...
                $perPage = $this->perPage;//к-сть записів на сторінці
...
//                $makeProductPager = $this->makeProductPager($count_responses_2, $perPage);
                ...
                $data = [
                    ...
                    'everything_responses_count' => $everything_responses_count,
